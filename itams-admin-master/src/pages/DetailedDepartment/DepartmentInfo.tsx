...
import { deleteDepartment, getDepartmentById } from '../../api/department';
...
export default function DepartmentInfo(props: any) {
  ...
  const getData = async () => {
    try {
      const department: Department = await getDepartmentById(departmentId);
