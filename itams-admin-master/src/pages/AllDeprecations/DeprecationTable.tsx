...
import { deleteDeprecation, getAllDeprecations } from '../../api/deprecation';
...
import { Deprecation } from '../../interface/interface';
...
function EnhancedTableHead(props: EnhancedTableProps) {
  ...
  const createSortHandler =
    (property: keyof Deprecation) => (event: React.MouseEvent<unknown>) => {
...
export default function DeprecationTable() {
  ...
  const [rows, setRows] = React.useState<Deprecation[]>([]);
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{`${row.months} month${
                        row.months > 1 ? 's' : ''
                      }`}</TableCell>
